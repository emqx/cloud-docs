...
You can directly use the [Free Public MQTT Server](https://www.emqx.com/en/mqtt/public-mqtt5-broker) provided by EMQX, which is based on EMQX's [MQTT IoT Cloud Platform](https: //www.emqx.com/zh/cloud) created. The server access information is as follows:
