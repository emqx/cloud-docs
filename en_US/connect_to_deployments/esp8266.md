...
Before connecting the ESP8266 client to the MQTT Broker, you need to get the broker and client ready.
...
5. After successfully connecting to the MQTT broker, ESP8266 client will publish messages on topic `ESP8266/test` to the MQTT server and subscribe to messages on topic `esp8266/test`.
...
6. After successfully connecting to the MQTT broker, ESP8266 client will publish messages and subscribe to the MQTT broker.
...
After the ESP8266 client has successfully connected to the MQTT broker, you can use the Arduino IDE and MQTT X to test the connection.
