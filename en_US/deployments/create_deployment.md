...
3. Choose the deployment of the corresponding specifications according to your needs.
   ...
   * Select region: EMQ X Cloud temporarily supports AWS (US East(N.Virginia), US West(Oregon), EU(Ireland), Asia Pacific(Singapore)) and Azure (East US, Germany West Central, Southeast Asia). If you have other regional requirements, you can submit [tickets](../contact.md) or contact us via email (cloud@emqx.io).
