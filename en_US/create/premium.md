...
The EMQX Premium Plan offers independent MQTT service clusters with higher connection and Transactions Per Second (TPS) limits. It also supports more advanced features and complex network architectures. This guide uses the Premium Plan as an example to walk you through the steps of creating and utilizing the EMQX Platform.
...
To explore the advanced features of the Premium Plan, refer to the following links to the specific sections.
