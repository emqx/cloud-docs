...
4. Configure the cloud platform and EMQX cluster according to your needs.
   ...
   **Cloud platform configuration**
   ...
   - **Choose Cloud Platform**: Select **Google Cloud**.
