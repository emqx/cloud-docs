...
::: tip Tip
If the test fails, please check whether the [VPC peering connection](../deployments/security_features_and_settings/vpc_peering.md) is completed and whether the IP address is correct. 
:::
