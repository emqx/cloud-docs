...
![EMQX Cloud-MQTT 集成](./_assets/data_integraion_mqtt.jpg)
...
在创建数据集成的规则之前，您需要先创建一个 MQTT服务 连接器用于访问 MQTT 服务。
...
3. 您可以在 MQTTX 外部 MQTT 服务订阅到 `pub/temp_hum/emqx` 主题的消息，表示消息已经成功从 EMQX Cloud 转发到外部 MQTT 服务：
