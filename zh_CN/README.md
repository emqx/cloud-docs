...
EMQ X Cloud 是全球首个全托管的 MQTT 5.0 公有云服务，向首次注册用户提供 6 个月免费试用。
...
![](https://static.emqx.net/images/b7f3e53a4f6a789c698e5af8476d3e51.png)
...
支持实时预处理设备事件与消息数据，并存储到云上 MySQL、Kafak、InfluxDB 等十余种数据库与消息系统中。
