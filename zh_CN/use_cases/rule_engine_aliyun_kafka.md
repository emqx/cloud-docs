...
![](../_assets/deployments/rule_engine/buy_aliyun_kafka02.png)
...
![](../_assets/deployments/rule_engine/buy_aliyun_kafka_emqx_deployment.png)
...
![](../_assets/deployments/rule_engine/set_aliyun_kafka_topic.png)

3.2 在 Kafka 实例详情中，白名单 IP 加入: 0.0.0.0/0

![](../_assets/deployments/rule_engine/set_aliyun_kafka_white_list.png)

3.3 记录下 Kafka 实例的 IP 地址。

![](../_assets/deployments/rule_engine/record_aliyun_kafka_ip.png)
...
注意：如果测试失败，请检查是否完成对等连接，详情请看 VPC 对等连接，并检查 Kafka 服务器地址是否正确。
...
![](../_assets/deployments/rule_engine/check_aliyun_kafka_message.png)
