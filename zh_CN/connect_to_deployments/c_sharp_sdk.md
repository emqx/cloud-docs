...
>2. 在 **访问控制** > **客户端认证** 中设置用户名和密码，用于连接验证。
...
### C# MQTT 客户端库使用
本文将使用 EMQX 提供的 [免费公共 MQTT 服务器](https://www.emqx.com/zh/mqtt/public-mqtt5-broker) ，该服务基于 EMQX 的 [MQTT 物联网云平台](https://www.emqx.com/zh) 创建。服务器接入信息如下：
