...
![测试 SQL](../_assets/deployments/rule_engine/republish_SQL_setting.png)

### 2. 创建动作

点击添加动作，在选择动作页，选择 `消息重新发布`，点击下一步

![选择动作](../_assets/deployments/rule_engine/add_republish_action01.png)

在配置动作页面中，目的主题设为 greet，在消息内容模板里填写 "${msg} -- forward from emqx cloud"，目的 QoS 默认。点击确定。

![配置动作](../_assets/deployments/rule_engine/add_republish_action02.png)

创建好的动作会显示在响应动作一栏里，确认信息无误后，点击右下角的确认，完成规则引擎的配置。

![完成规则引擎](../_assets/deployments/rule_engine/add_republish_action03.png)
...
![查看动作指标](../_assets/deployments/rule_engine/add_republish_action04.png)

同时收到了来自主题 greet 的消息转发。

![收到转发消息](../_assets/deployments/rule_engine/add_republish_action05.png)
